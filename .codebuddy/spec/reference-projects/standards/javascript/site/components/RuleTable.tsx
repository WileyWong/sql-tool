...
const RuleTable: React.SFC<RuleTableProps> = ({ namespace, hideOff }) => (
  <div className="container-fluid">
    ...
    {
      Object.values<Rule>(NAMESPACE_CONFIG[namespace].ruleConfig)
        .map(({ name, value, description, reason, badExample, goodExample }) => (
          <div
            id={name}
            key={name}
